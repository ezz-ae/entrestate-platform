    ...
    tools: [
      {
        ...
        alt: 'The Meta campaign desk listing six campaigns with delivery badges, impressions, clicks, spend, leads and CPL per row',
        keyword: 'Ads with brakes.',
        caption: 'Every campaign on one desk — spend, leads and cost-per-lead printed per row.',
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        alt: 'Lead gen forms, each row carrying its CRM count, average value rating and rated share',
        keyword: 'Forms, straight in.',
        caption: 'Every form carries its own rate — leads in the CRM, value rating, rated share.',
        learn: '/business/docs/lead-flow',
        cards: [
          { title: 'The form’s rate', body: 'Leads in CRM, average value, how many rated — per form.' },
