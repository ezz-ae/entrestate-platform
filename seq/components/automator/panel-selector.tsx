...
export function PanelSelector({
  ...
  const loadDemoSequence = () => {
    ...
    toast({
      title: "Sample loaded",
      description: `Loaded ${demoFinalPanels.length} sample panels`,
    })
  }
      ...
      <CardHeader className="pb-3">
        ...
        <details className="mt-3 text-xs bg-secondary/50 border border-border rounded-lg">
          ...
          <div className="px-3 pb-3 text-muted-foreground">
            Use approved project names and neutral descriptions. Avoid third-party brand names or trademarked content
            in your briefs.
          </div>
        </details>
      </CardHeader>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {localPanels.map((url, i) => {
                    ...
                    return (
                      ...
                      >
                        <Image src={url || "/seq-poster.svg"} alt={`Panel ${i + 1}`} fill className="object-cover" />
                ...
                {customImages.length > 0 ? (
                  <div className="grid grid-cols-3 gap-3">
                    {customImages.map((url, i) => (
                      ...
                      >
                        <Image src={url || "/seq-poster.svg"} alt={`Custom ${i + 1}`} fill className="object-cover" />
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                title="Add a start→end pair for motion or a smooth transition"
              >
          ...
          <div className="space-y-3 min-h-[400px]">
            {finalPanels.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-64 border-2 border-dashed border-zinc-700 rounded-lg gap-4">
                ...
                <p className="text-zinc-600 text-xs">or add a transition pair for start→end motion</p>
              </div>
            ) : (
                  ...
                  {panel.type === "single" && panel.imageUrl ? (
                    ...
                    <div className="flex gap-2 flex-1 items-center">
                      ...
                      <Badge
                        ...
                        title="Start→end motion between two frames"
                      >
                        Start → End
                      </Badge>
                    </div>
