            ...
            {isTransitionPanel && panel.linkedImageUrl ? (
              <div className="w-full h-full flex gap-0.5">
                <div className="relative w-1/2 h-full">
                  <Image src={panel.imageUrl || "/seq-poster.svg"} alt="First frame" fill className="object-contain" />
        ...
        <div className="space-y-1.5">
          ...
          <Select defaultValue="veo3.1-fast" onValueChange={(val) => onUpdate(panel.id, { model: val as any })}>
            ...
            <SelectContent>
              {isTransitionPanel ? (
                <>
                  <SelectItem value="veo3-fast">Quick Cut</SelectItem>
                  <SelectItem value="veo3-standard">Studio</SelectItem>
                  <SelectItem value="wan-2.2">Smooth Transition</SelectItem>
                </>
              ) : (
                <>
                  <SelectItem value="veo3-fast">Quick Cut</SelectItem>
          ...
          <p className="text-[9px] text-muted-foreground/50 leading-tight">
            {isTransitionPanel
              ? "If a clip fails, switch the render profile and retry."
              : "If a clip fails, switch the render profile and retry."}
          </p>
        </div>
          ...
          <Textarea
            ...
            placeholder={
              isTransitionPanel
                ...
                : "Describe the motion for this shot (e.g. 'Zoom in slowly'). Use 'Refine' to combine with the master brief."
            }
