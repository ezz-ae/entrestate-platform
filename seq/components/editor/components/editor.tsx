...
export const Editor: React.FC<EditorProps> = ({
  ...
  const [prompt, setPrompt] = useState(
    initialPrompt || "Waterfront tower exterior at sunset, skyline glow, calm marina, premium lifestyle energy",
  )
  const [useUrls, setUseUrls] = useState(Boolean(initialImageUrl))
  ...
  useEffect(() => {
    ...
    if (initialImageUrl) {
      setUseUrls(true)
      handleUrlChange(initialImageUrl, 1)
    }
  }, [initialPrompt, initialImageUrl, handleUrlChange])
