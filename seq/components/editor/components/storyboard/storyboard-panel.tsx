    ...
    <Card className="flex flex-col overflow-hidden bg-black/40 border-white/10 group relative h-full">
      ...
      <div className="relative aspect-video bg-black/50 group/preview">
            ...
            {isTransitionPanel && panel.linkedImageUrl ? (
              <div className="w-full h-full flex gap-0.5">
                <div className="relative w-1/2 h-full">
                  <img
                    src={panel.imageUrl || "/seq-poster.svg"}
                    alt="First frame"
                ...
                <div className="relative w-1/2 h-full">
                  <img
                    src={panel.linkedImageUrl || "/seq-poster.svg"}
                    alt="Last frame"
                    className="w-full h-full object-cover"
                  />
        ...
        {panel.isGenerating && (
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-black/60 backdrop-blur-[1px]">
            ...
            <span className="text-xs text-white/80 font-medium animate-pulse">Building clip...</span>
          </div>
        )}
      </div>
      ...
      <div className="p-3 flex flex-col gap-3 bg-black/20 flex-1">
        <div className="space-y-1.5">
          <label className="text-[10px] uppercase tracking-wider text-white/40 font-semibold">Render profile</label>
          <Select
          ...
          >
            ...
            <SelectContent className="bg-zinc-900 border-zinc-800">
              {isTransitionPanel ? (
                <>
                  <SelectItem value="veo3.1-fast">Quick Cut</SelectItem>
                  <SelectItem value="veo3.1-standard">Studio</SelectItem>
                  <SelectItem value="wan-2.2-transition">Smooth Transition</SelectItem>
                </>
              ) : (
                <>
                  <SelectItem value="veo3.1-fast">Quick Cut</SelectItem>
                  <SelectItem value="veo3.1-standard">Studio</SelectItem>
                  <SelectItem value="wan-2.5">Cinema</SelectItem>
                </>
              )}
            </SelectContent>
          </Select>
        ...
        <div className="space-y-1.5 flex-1 min-h-0 flex flex-col">
          <div className="flex items-center justify-between">
            <label className="text-[10px] uppercase tracking-wider text-white/40 font-semibold">Clip brief</label>
            <div className="flex items-center gap-2">
              {/* Enhance Button */}
              <Button
                size="sm"
          ...
          <Textarea
            ...
            placeholder={
              isTransitionPanel
                ? "Describe the transition (e.g. 'Smooth zoom out')"
