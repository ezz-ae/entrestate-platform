...
|---|---|---|
| "Find your next home" | "Real Estate Decision Infrastructure — Live Demo" | Signals infrastructure, not marketplace |
...
| Areas/Developers pages | "Data Coverage — 2,813 projects, 7,217 leasing folders, 36,841 DLD transactions, 167 areas, 75 developers" | Shows data moat |
...
### Database (verified core surfaces)
| Surface | Rows | Powers |
|---|---|---|
| `public.entrestate_projects_api` | 2,813 | /properties page |
| `public.entrestate_areas_api` | 167 | /areas page |
| `api.entrestate_developers_api` | 75 | /developers page |
| `api.dld_transactions_v1` | 36,841 | Market intelligence |
| `canonical.dld_area_benchmarks_live` | 183 | Area benchmarks + market pulse |
| `canonical.inventory_clean` | 2,813 | Decision Engine base |
| `raw.inventory_full` | 7,015 | Full inventory detail |

### Leasing Infrastructure (in DB, not yet on frontend)
| Table | Rows | Ready For Demo |
|---|---|---|
| `entrestate.folders` | 7,217 | Transaction workspace API |
| `entrestate.listing_imports` | seeded | Multi-source ingestion |
| `entrestate.folder_holds` | active | Inventory Lock Protocol |
| `entrestate.folder_queue_entries` | active | Queue management |
| `entrestate.contact_consents` | active | Trust Protocol |
| `entrestate.whatsapp_intent_config` | 8 intents | Structured Action Protocol |
...
<section className="hero">
  ...
  <p className="stats">
    2,813 projects · 7,217 leasing folders · 36,841 DLD transactions · 167 areas · 75 developers
  </p>
...
<p>Cross-referenced: PropertyFinder · DLD · Entrestate Spine</p>
