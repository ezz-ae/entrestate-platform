...
export const TimelineRuler: React.FC<TimelineRulerProps> = ({ duration, zoomLevel, scrollContainerRef, onClick }) => {
  ...
  return (
    <div className="h-8 w-full sticky top-[var(--app-header-height)] left-0 z-30 bg-[var(--surface-0)] border-b border-[var(--border-default)] pointer-events-auto overflow-hidden">
