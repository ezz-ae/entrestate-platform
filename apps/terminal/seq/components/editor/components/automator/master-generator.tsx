    ...
    <div className="space-y-4 max-w-2xl mx-auto">
      <div className="text-center space-y-2 mb-8">
        ...
        <p className="text-muted-foreground">
          Create a new storyboard or upload a master board to begin the flow.
        </p>
      </div>
          ...
          <Tabs defaultValue="generate" className="w-full" onValueChange={handleModeChange}>
            ...
            <TabsContent value="generate" className="space-y-4">
              <div className="space-y-2">
                ...
                <Textarea
                  placeholder="E.g., A waterfront launch story showing arrival, lobby, amenities, skyline, and sunset across 6 panels..."
            ...
            <TabsContent value="upload" className="space-y-6">
              ...
              >
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <h3 className="font-medium text-lg">Click to upload a master board</h3>
              ...
              <div className="space-y-2">
                ...
                <Input
                  placeholder="Describe the tone or styling to keep consistency..."
