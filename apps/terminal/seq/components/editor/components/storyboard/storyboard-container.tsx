...
export function StoryboardContainer({
  ...
  const generateVideo = async (id: string) => {
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : "Failed to build clip"
      updatePanel(id, {
        isGenerating: false,
        error: message,
      })
    ...
    <div className="w-full space-y-4">
      <div className="flex items-center justify-between px-1">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold text-white/80">Clip Storyboard</h2>
        ...
        <div className="px-1">
          <div className="text-xs text-white/40 bg-white/5 border border-white/10 rounded-lg p-3 flex items-start gap-2">
              ...
              <div>
                ...
                <p>
                  Your selected panels are ready. You can now add shot notes manually, use the "Load sample notes" button
                  to pre-fill example notes, or refine notes using the master description.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="px-1 space-y-3">
        <div className="space-y-1.5">
          ...
          <Textarea
            ...
            placeholder="Describe the overall story, style, or context (e.g. 'Waterfront launch at sunset'). This will be used to refine individual shot notes."
        ...
        <div className="border border-white/10 bg-white/5 rounded-lg p-3">
          <div className="flex items-center gap-2 mb-3">
            ...
            <label className="text-[10px] uppercase tracking-wider text-white/60 font-semibold">
              Clip settings (applies to all panels)
            </label>
          </div>
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] text-white/50 font-medium">Render speed</label>
              <Select
