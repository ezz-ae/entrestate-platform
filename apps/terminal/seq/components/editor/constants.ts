...
export const VIDEO_MODELS = [
  { id: "fal-ai/minimax-video", name: "Quick Cut", description: "Fast turnaround for drafts" },
  { id: "fal-ai/hunyuan-video", name: "Studio Plus", description: "Balanced detail and speed" },
  { id: "fal-ai/veo-2", name: "Cinema", description: "Highest clarity for final output" },
] as const
