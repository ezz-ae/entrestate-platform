...
A professional, browser-based non-linear video editor (NLE) built with React and Next.js. Features studio-driven video generation, multi-track timeline editing, and FFmpeg-based export.
...
│   ├── automator/       # Studio generation components
