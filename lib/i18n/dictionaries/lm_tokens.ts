...
const en: Dict = {
  ...
  'tok.priceNote': 'A launch costs 1 token for every AED 10 of its daily budget. Your ad spend stays in your own Meta account.',
...
const ar: Dict = {
  ...
  'tok.priceNote': 'يكلّف الإطلاق نقطة واحدة عن كل 10 دراهم من ميزانيته اليومية. ويبقى إنفاقك الإعلاني في حساب ميتا الخاص بك.',
...
const ru: Dict = {
  ...
  'tok.priceNote': 'Запуск стоит 1 кредит за каждые 10 AED дневного бюджета. Рекламные расходы остаются в вашем собственном аккаунте Meta.',
