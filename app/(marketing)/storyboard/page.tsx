...
const STEPS = [
  { key: "prompt", label: "Brief", icon: Wand2 },
...
export default function StoryboardPage() {
  ...
  const initialImageUrl = useMemo(() => searchParams.get("media") || "", [searchParams])
  ...
  return (
    <AppShell>
      <div className="min-h-screen bg-background text-foreground">
        ...
        <header className="sticky top-[var(--app-header-height)] z-40 border-b border-border bg-background/95 backdrop-blur-xl">
          <div className="px-6">
            {/* Top bar */}
        ...
        <main id="main-content" className="px-6 py-6 max-w-6xl mx-auto">
          ...
          {step === "prompt" && (
            <MasterGenerator
              onGenerate={handleMasterGenerated}
            ...
            <div className="space-y-6 animate-in fade-in duration-500">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Build clips for each panel, then export your sequence.
                </p>
              </div>
