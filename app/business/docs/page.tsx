  ...
  return (
    <Section className="pb-20 pt-14 lg:pb-28 lg:pt-20">
      <div className="max-w-[44rem]">
        ...
        <h1 className="mt-5 font-sans font-semibold text-[2.5rem] leading-[1.1] tracking-[-0.02em] text-ink sm:text-[3rem]">
          Learn Entrestate
        </h1>
        <Lede className="mt-5">
          ...
          return (
            ...
            <section key={category} id={docsCategoryId(category)} className="scroll-mt-24">
              <div className="flex flex-wrap items-baseline justify-between gap-x-6 gap-y-1 border-b border-line pb-4">
                <h2 className="text-[1.25rem] font-semibold tracking-[-0.01em] text-ink">{category}</h2>
                <p className="text-[0.875rem] text-ink-faint">{CATEGORY_LINES[category]}</p>
              </div>
